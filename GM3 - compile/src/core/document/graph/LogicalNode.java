...
public class LogicalNode implements INode<LogicalNode>, ObservableValue<LogicalNode> {
    ...
    public final HashMap<Object, HashMap<String, Set<ComputedProperty>>> fingerprintPayloadResults;
    public final HashMap<String, Set<ComputedProperty>> annotations;
    ...
    public final LazyProperty<Cidr> network;
